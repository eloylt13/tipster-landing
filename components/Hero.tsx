  ...
  return (
    <section className="grid gap-6 py-10 sm:py-12 lg:grid-cols-[1.06fr_0.94fr] lg:items-center lg:gap-8">
      <div>
        ...
        <p className="mt-4 max-w-2xl text-[0.98rem] leading-7 text-slate-300 sm:text-[1.05rem]">
          {content.description}
        </p>
      ...
      <div className="rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,_rgba(255,255,255,0.07),_rgba(255,255,255,0.03))] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.26)] backdrop-blur-sm sm:p-6">
        ...
        <ul className="mt-5 grid gap-3">
          {content.highlights.map((item) => (
            <li
              key={item}
              className="rounded-[1.1rem] border border-white/10 bg-black/20 px-4 py-4 text-sm leading-6 text-slate-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]"
            >
              {item}
            </li>
          ))}
