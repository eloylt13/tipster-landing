...
export default function GraciasPage() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(93,103,255,0.12),_transparent_34%),linear-gradient(180deg,_#070a12_0%,_#090d16_100%)] px-4 py-8 text-white sm:px-6 lg:px-8">
      <section className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-2xl flex-col justify-center">
        <div className="rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,_rgba(255,255,255,0.07),_rgba(255,255,255,0.03))] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.32)] backdrop-blur-sm sm:p-8">
          ...
          <p className="mt-4 max-w-xl text-sm leading-7 text-slate-300 sm:text-[0.98rem]">
